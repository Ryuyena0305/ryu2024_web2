...
public class RestController3 {
    ...
    //[3]
    @GetMapping("/doget3")
    public int method3(@RequestParam(name="name")String name,@RequestParam(name="age") int age){
        System.out.println("RestController3.method3");
        System.out.println("name = " + name + "age = " + age);
        return 3;
    }
    //[3] 컬렉션 프레임워크를 이용한 퀴리스트링 매개변수 매핑
    @GetMapping("/doget4")
    ...
    @GetMapping("/doget5")
    public boolean method5( MemberDto memberDto){ //여러개의 매개변수를 하나의 DTO로 받을 수 있다

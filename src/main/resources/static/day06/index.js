...
//* 주의할 점 : 객체가 상수에 저장하고 객체내 속성값 수정 가능하다.
const obj = { name : '정준재' }
obj.name = '박성한'
...
//[2] 함수
    ...
    //정의2 : 익명 함수 , 주로 변수/상수 저장해서 사용한다. 이벤트함수
    ...
    fun2('정준재','박성한')
    fun3(10,'정준재')
    //+ 기본 매개변수 값 정의 : 인자가 없을때 기본값을 대입할 수 있다.
    const fun4 = (param1,param2,param3='학생')=>{}
    fun4('유재석',10)

    //[3] 객체 : {}객체 : key와 value 으로 한쌍을 구성하여 여러쌍을 {}묶음 , []리스트/배열
        //1. 객체 : {ket:value, key : value}
    const obj={'name':'정준재','age':'23'}
    //2.속성명 단축
    const name3 = '박성한';
    const age3 = 28;
    const obj3 = {name3,age3}; //vs {name3:name3,age3:age}
    //3. 객체의 속성값 호출, .(접근연산자)
    ...
    //6. + 스프레드 연산자 , 배열이나 객체를 복사하거나 합칠때 사용

...
function Component3(props) {
    return (<>
        <h4>div 대신에 이름없는 마크업을 사용 가능하다.</h4>
    </>)
}
...
function Component6(props) {
    ...
    //JSX 문법의 목록(li,option 등)마크업들에는 key 속성 필요로 한다.
    //JSX 문법에서는 forEach 함수 보다 map 함수 자주 사용된다
...
function Component7(props){
    ...
    return (<>
    <h4 style={{color : 'blue'}}>인라인 형식의 CSS넣기</h4>
    <h4 style={cssObj}> 인라인 형식의 객체CSS</h4>
    <h4 className ="myclass">css파일내 선택자 이용한 CSS</h4>
    </>)
}